...
public class Style {
	...
	//images
	public static final Image WIDGET_VALIDATED_LABLED_TEXT_IMAGE_WARNING = new Image(Display.getCurrent(), Style.class.getResourceAsStream("exlamationMark_20px.png")); ;
	public static final Image WIDGET_VALIDATED_LABLED_TEXT_IMAGE_INFO = new Image(Display.getCurrent(), Style.class.getResourceAsStream("eye_20px.png")); ;
